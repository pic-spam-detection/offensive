...
class SpamDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "text": text,
            "title": title,
            "text_tokenized": text_tokenized["input_ids"].squeeze(
                0
            ),  # Remove the batch dimension
            "title_tokenized": title_tokenized["input_ids"].squeeze(0),
            "text_tokenized_attention_mask": text_tokenized["attention_mask"].squeeze(
                0
            ),
            "title_tokenized_attention_mask": title_tokenized["attention_mask"].squeeze(
                0
            ),
        }
